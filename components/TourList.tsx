        ...
        [1, 2, 3, 4, 5, 6, 7].map(item => {
          return <div className="tour-item">
            <div className="relative">
              ...
              <div className="tour-price bg-cyan-600">50,000 円から～</div>
            </div>
            ...
            <div className="px-6 pb-4">
              <span className="inline-block bg-orange-500 rounded-full px-3 py-1 text-xs font-normal text-white mr-2 mb-2">日本語ガイド</span>
